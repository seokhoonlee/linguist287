...
if sys.version_info < (2, 5):
    print "This program requires Python 2.5 or greater. You're running version %s.%s.%s" % sys.version_info[0:3]
    sys.exit(2)
import os
import copy
...
try:
    ...
    sys.stderr.write("Couldn't find the ParallelPython library. To get it: http://www.nltk.org/.\n")
try:
    import nltk.corpus
    from nltk.corpus import wordnet as wn
    from nltk.corpus import WordNetCorpusReader
except ImportError:
    sys.stderr.write("Couldn't find an NLTK installation. To get it: http://www.parallelpython.com/.\n")
    sys.exit(2)

# NLTK's WordNetCorpusReader needs this as an argument.
WN_ROOT = "/Volumes/CHRIS/Applications/WordNet-3.0/dict/"
if not os.path.exists(WN_ROOT):
    raise IOError("Please change the value of WN_ROOT to point to the dict/ subdirectory of your copy of WordNet.")
